...
const Hero = () => {
  ...
  const invitationText = "The wedding of";
...
>
  ...
  <Box
    ...
    src={hero.banner_left}
    sx={{
      objectFit: "scale-down",
      objectPosition: "left",
      width: "40%", // Adjust width as per your requirement
      height: "40vh", // Adjust height as per your requirement
      position: "absolute",
      top: 0,
      left: 0,
  ...
  >
    <Container>
      ...
      >
        {invitationText.split(" ").map((text, key) => (
      ...
      >
        {wedding.reception.date.split(" ").map((text, key) => (
          <TextMask key={key} variants={textVariants}>
            {text}
          </TextMask>
        ))}
